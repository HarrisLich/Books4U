        ...
        <div className="w-full flex flex-col" style={{ height: "calc(100vh)" }}>
            ...
            <div className="grid w-full h-full grid-rows-3">
                <div className="row-span-2 w-full h-full flex flex-col relative items-center justify-center transition-all duration-300 ease-in">
                    ...
                    <div id="swiperContainer" className="large:w-[1200px] desktop:w-[800px] laptop:w-[800px] tablet:w-[200px] w-[1200px] mt-[4rem] absolute">
                        <BookSwiper/>
                    </div>
                    <div id="NYTSwiperContainer" className="mt-[4rem] absolute large:w-[1200px] desktop:w-[800px] laptop:w-[800px] tablet:w-[200px] w-[1200px]" style={{opacity: 0}}>
